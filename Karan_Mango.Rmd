...
gwp_organic = ggplot(org_simple, aes(x = Year, y = GWP_annual))+
  geom_line()+
  labs(x = "Year", y = "Annual GWP", title = "Annual GWP Change")+
  theme_gdocs()
gwp_organic
...
gwp_regen_total = ggplot(org_simple, aes(x = Year, y = GWP_total))+
  geom_line()+
...
carbon_sqstr = ggplot()+
  ...
  labs(x = "Year", y = "Carbon Sequestered (kg/ha)", title = "Carbon Sequestration of Regen vs Organic")+
  scale_color_discrete(name = "Legend", labels = c("Organic", "Regen"))+
  theme_gdocs(base_size=11)
