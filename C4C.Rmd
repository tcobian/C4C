...
ch4_n20_regen_plot<- ggplot(ch4_n2o_regen, aes(y = kg_co2e, x = Practice, fill = Gas))+
...
ch4_n20_organic_plot<- ggplot(ch4_n2o_organic, aes(y = kg_co2e, x = Practice, fill = Gas))+
  geom_bar(stat = "identity", position = "dodge", show.legend = "False")+
  facet_wrap(~Crop)+
...
cotton_regen_india_nt_g<- cotton_tillage$GWP[60]-cotton_tillage$GWP[43]
cotton_regen_china_nt_g<-cotton_tillage$GWP[20]-cotton_tillage$GWP[3]
cotton_regen_texas_nt_g<-cotton_tillage$GWP[40]-cotton_tillage$GWP[23]
cotton_regen_peru_nt_g<-cotton_tillage$GWP[80]-cotton_tillage$GWP[63]

cotton_till_india_g<-cotton_tillage$GWP[100]-cotton_tillage$GWP[83]
cotton_till_china_g<-cotton_tillage$GWP[120]-cotton_tillage$GWP[103]
cotton_till_texas_g<-cotton_tillage$GWP[160]-cotton_tillage$GWP[143]
cotton_till_peru_g<-cotton_tillage$GWP[140]-cotton_tillage$GWP[123]

tillage_data<- data.frame(Country = c("India", "India", "China", "China", "Texas", "Texas","Peru", "Peru"),
                   Practice = c("Regenerative", "Tillage", "Regenerative", "Tillage", "Regenerative", "Tillage", "Regenerative", "Tillage"),
