...
SOC <- data.frame(Location = c("Minnesota", "Minnesota","South Dakota", "South Dakota", "Texas", "Texas"," Nicaragua", "Nicaragua"),
                  Practice = c("Regenerative", "Organic", "Regenerative", "Organic", "Regenerative", "Organic", "Regenerative", "Organic"),
                  End_SOC = c(kernza, kernza, bison, bison, cotton, cotton, mango, mango)) 
                  
kernza_regen_SOC <- kernza %>% 
  filter(Country == "US_MN",
         Practice == "Regen")

kernza_organic_SOC <- kernza %>% 
  filter(Country == "US_MN",
         Practice == "Organic")

bison_regen_SOC <- bison %>% 
  filter(site == "SD",
         Practice == "regen")

bison_organic_SOC <- bison %>% 
  filter(site == "SD",
         practice == "organic")

cotton_regen_SOC <- cotton %>% 
  filter(Country == "Texas",
         Practice == "Regenerative")

cotton_organic_SOC <- cotton %>% 
  filter(Country == "Texas",
         Practice == "Organic")

mango_regen_SOC <- mango %>% 
  filter(site == "Nicaragua",
         practice == "regen")

mango_organic_SOC <- mango %>% 
  filter(site == "Nicaragua",
         practice == "organic")
...
cotton_regen_india_nt_s<- cotton_tillage$End_SOC[60]-cotton_tillage$End_SOC[43]
cotton_regen_china_nt_s<-cotton_tillage$End_SOC[20]-cotton_tillage$End_SOC[3]
cotton_regen_texas_nt_s<-cotton_tillage$End_SOC[40]-cotton_tillage$End_SOC[23]
cotton_regen_peru_nt_s<-cotton_tillage$End_SOC[80]-cotton_tillage$End_SOC[63]

cotton_till_india_s<-cotton_tillage$End_SOC[100]-cotton_tillage$End_SOC[83]
cotton_till_china_s<-cotton_tillage$End_SOC[120]-cotton_tillage$End_SOC[103]
cotton_till_texas_s<-cotton_tillage$End_SOC[160]-cotton_tillage$End_SOC[143]
cotton_till_peru_s<-cotton_tillage$End_SOC[140]-cotton_tillage$End_SOC[123]
