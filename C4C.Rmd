...
kernza_gwp <- ggplot()+
  ...
  geom_text(aes(x = 16, y = 150, label = 'Regenerative'))+
  geom_line(data = kernza_organic_SOC, aes(x = Year, y = GWP), col = "darkorange2")+
  geom_text(aes(x = 16, y = 50, label = 'Organic'))+
...
cotton_gwp <- ggplot()+
  ...
  geom_text(aes(x = 16, y = 55000, label = 'Regenerative'))+
  geom_line(data = cotton_organic_SOC, aes(x = Year, y = GWP), col = "darkorange2")+
  geom_text(aes(x = 16, y = 86000, label = 'Organic'))+
  labs(title = "Cotton", y = element_blank(), x = element_blank())+
  theme_classic()+
  theme(plot.title = element_text(hjust = 0.5)) # center the graph
...
mango_gwp <- ggplot ()+
  ...
  geom_text(aes(x = 16, y = -5000, label = 'Regenerative'))+
