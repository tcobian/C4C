...
kernza_gwp <- ggplot()+
  ...
  geom_text(aes(x = 8, y = 100, label = 'Regenerative'))+
  geom_line(data = kernza_organic_SOC, aes(x = Year, y = GWP), col = "darkorange2")+
  geom_text(aes(x = 4, y = 350, label = 'Organic'))+
...
bison_gwp <- ggplot()+
  ...
  geom_text(aes(x = 12, y = 3200, label = 'Regenerative'))+
  geom_line(data = bison_organic_SOC, aes(x = Year, y = GWP), col = "darkorange2")+
  geom_text(aes(x = 4, y = 1300, label = 'Organic'))+
...
cotton_gwp <- ggplot()+
  ...
  geom_text(aes(x = 6, y = 50000, label = 'Regenerative'))+
  geom_line(data = cotton_organic_SOC, aes(x = Year, y = GWP), col = "darkorange2")+
  geom_text(aes(x = 8, y = 60000, label = 'Organic'))+
  labs(title = "Cotton", y = element_blank(), x = element_blank())+
  theme_classic()+
  theme(plot.title = element_text(hjust = 0.5)) # center the graph
...
mango_gwp <- ggplot ()+
  ...
  geom_text(aes(x = 12, y = 30000, label = 'Regenerative'))+
  geom_line(data = mango_organic_SOC, aes(x = Year, y = GWP), col = "darkorange2")+
  geom_text(aes(x = 16, y = 10000, label = 'Organic'))+
...
cotton_regen_india_nt_s<- mean(cotton_tillage$End_SOC[60:43])
cotton_regen_china_nt_s<-mean(cotton_tillage$End_SOC[20:3])
cotton_regen_texas_nt_s<-mean(cotton_tillage$End_SOC[40:23])
cotton_regen_peru_nt_s<-mean(cotton_tillage$End_SOC[80:63])

cotton_till_india_s<-mean(cotton_tillage$End_SOC[100:83])
cotton_till_china_s<-mean(cotton_tillage$End_SOC[120:103])
cotton_till_texas_s<-mean(cotton_tillage$End_SOC[160:143])
cotton_till_peru_s<-mean(cotton_tillage$End_SOC[140:123])


bison_regen_ch4<- mean(bison$CH4_GWP[63:80])
cotton_regen_india_nt_g<- mean(all_data$GWP[217:234])
cotton_regen_china_nt_g<-mean(all_data$GWP[181:198])
cotton_regen_texas_nt_g<-mean(all_data$GWP[199:216])
cotton_regen_peru_nt_g<-mean(all_data$GWP[235:252])

cotton_till_india_g<-mean(all_data$GWP[325:342])
cotton_till_china_g<-mean(all_data$GWP[477:494])
cotton_till_texas_g<-mean(all_data$GWP[513:530])
cotton_till_peru_g<-mean(all_data$GWP[495:512])
