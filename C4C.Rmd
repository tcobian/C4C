...
kernza_SOC <- ggplot()+
  ...
  labs(title = "Difference between the total change in SOC between regenerative and organic\n practices in Minnesota",
       y = "kg of Soil Organic Carbon per ha")+
  theme_classic()+
...
bison_SOC <- ggplot()+
  ...
  labs(title = "Difference between the total change in SOC between regenerative and organic\ngrazing practices in South Dakota",
       y = "kg of Soil Organic Carbon per ha")+
  theme_classic()+
  theme(plot.title = element_text(hjust = 0.5)) # center the graph
