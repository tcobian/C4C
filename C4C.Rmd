...
tillage_india_SOC_t<- t.test(all_data$dSOC[217:234], all_data$dSOC[343:360])
tillage_india_SOC_t
tillage_india_GWP_t<- t.test(all_data$GWP[217:234], all_data$GWP[343:360])
tillage_india_GWP_t

tillage_china_SOC_t<- t.test(all_data$dSOC[217:234], all_data$dSOC[343:360])
tillage_china_SOC_t
tillage_china_GWP_t<- t.test(all_data$GWP[217:234], all_data$GWP[343:360])
tillage_china_GWP_t

tillage_texas_SOC_t<- t.test(all_data$dSOC[217:234], all_data$dSOC[343:360])
tillage_texas_SOC_t
tillage_texas_GWP_t<- t.test(all_data$GWP[217:234], all_data$GWP[343:360])
tillage_texas_GWP_t

tillage_peru_SOC_t<- t.test(all_data$dSOC[217:234], all_data$dSOC[343:360])
tillage_peru_SOC_t
tillage_peru_GWP_t<- t.test(all_data$GWP[217:234], all_data$GWP[343:360])
tillage_peru_GWP_t
