...
mango_india_regen_gwp<- ((sum(mango$dSOC[1:18])/12)*44) + (((sum(mango$CH4[1:18])/12)*16)*28) + (((sum(mango$N2O_flux[1:18])/28)*44)*265)

mango_india_organic_gwp<- ((sum(mango$dSOC[19:36])/12)*44) + (((sum(mango$CH4[19:36])/12)*16)*28) + (((sum(mango$N2O_flux[19:36])/28)*44)*265)

mango_nicaragua_regen_gwp<- ((sum(mango$dSOC[37:54])/12)*44) + (((sum(mango$CH4[37:54])/12)*16)*28) + (((sum(mango$N2O_flux[37:54])/28)*44)*265)

mango_nicaragua_organic_gwp<- ((sum(mango$dSOC[55:72])/12)*44) + (((sum(mango$CH4[55:72])/12)*16)*28) + (((sum(mango$N2O_flux[55:72])/28)*44)*265)
